...
const int ARRAY_SIZE = 1 << 25; // feel free to change the size of array
...
int main(int argc, char* argv[]) {
    ...
    genArray(ARRAY_SIZE - 1, a, 4);  // Leave a 0 at the end to test that edge case
    a[ARRAY_SIZE - 1] = 0;
    printArray(ARRAY_SIZE, a, true);
